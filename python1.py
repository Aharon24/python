...
if  Templates == 1:
    ...
    print(f""" It was about {Number} {Measure_of_time} ago when I arrived at the hospital in a {Mode_of_Transportatino}. The hospital is a/an {Adjective } place, there are a lot of { Adjective2 } {Noun} here. 
   ...
   # Adjective = str(input("write Adjective :"))
    ...
    Noun2  =  str(input("write Noun   :"))
    print(f""""This weekend I am going camping with ({Persons_Name}). I packed my lantern, sleeping bag, and ({Noun}). I am so ({Feeling}) to ({Verb}) in a tent. 
    ...
    print(f"""Dear ({Person_Name}), I am writing to you from a ({Adjective}) castle in an enchanted forest. I found myself here one day after going for a ride on a 
